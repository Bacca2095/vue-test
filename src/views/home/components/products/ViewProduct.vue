<template>
    <div class="mt-20">
        <div class="product-image">
            <img v-if="image" class="w-full h-full overflow-y-hidden bg-slate-200" :src="image" alt="" />
            <div v-if="!image" class="w-full h-full bg-slate-200">
                <span class="text-slate-600">Photo</span>
            </div>
        </div>
        <div class="product-description mt-4 pb-4">
            <div class="name">
        ...
        <div class="product-options mx-3 mt-6 flex flex-col">
        ...
        <div class="product-quantity mx-3 flex flex-col mb-3">
            <div class="size flex my-2 md:justify-center">
        ...
        <div class="flex mx-3 flex-col mb-5">
